...
%Channel_EMG1EMG2_General
 ...
 cd('E:\darji')
 save Narco_Results_HjP narco narco_results all_narco_combined_Hjorth
...
temp_LSS_narco=[N1_narco; N2_narco]; temp_LSS_narco(:,25)=1;
LSS_normal_vs_narco = [temp_LSS_normal; temp_LSS_narco];

temp_NREM_normal=[N1_normal; N2_normal; N3_normal]; temp_NREM_normal(:,25)=0;
temp_NREM_narco=[N1_narco; N2_narco; N3_narco]; temp_NREM_narco(:,25)=1;
NREM_normal_vs_narco = [temp_NREM_normal; temp_NREM_narco];

all_normal_combined_Hjorth(:,25)=0;
all_narco_combined_Hjorth(:,25)=1;
Allstages_normal_vs_narco = [all_normal_combined_Hjorth; all_narco_combined_Hjorth];

cd('E:\darji')
save Normal_vs_Narco_HjP W_normal_vs_narco N1_normal_vs_narco N2_normal_vs_narco N3_normal_vs_narco R_normal_vs_narco LSS_normal_vs_narco NREM_normal_vs_narco Allstages_normal_vs_narco
